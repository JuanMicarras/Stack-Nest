...
var OrdersService = function () {
    ...
    var OrdersService = _classThis = /** @class */ (function () {
        function OrdersService_1(orderRepo, orderItemRepo) {
            this.orderRepo = orderRepo;
            this.orderItemRepo = orderItemRepo;
        }
        OrdersService_1.prototype.createOrder = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var totalAmountNumber, itemsCount, orderId, order, items, saved;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            totalAmountNumber = dto.items.reduce(function (acc, item) { return acc + item.quantity * item.price; }, 0);
                            itemsCount = dto.items.reduce(function (acc, item) { return acc + item.quantity; }, 0);
                            orderId = (0, uuid_1.v4)();
                            ...
                            items = dto.items.map(function (item) {
