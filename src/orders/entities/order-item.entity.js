...
var OrderItem = function () {
    ...
    var OrderItem = _classThis = /** @class */ (function () {
        function OrderItem_1() {
            ...
            this.order = (__runInitializers(this, _price_extraInitializers), __runInitializers(this, _order_initializers, void 0));
    ...
    (function () {
        ...
        _orderId_decorators = [(0, typeorm_1.Column)({ name: 'order_id' })];
        ...
        _order_decorators = [(0, typeorm_1.ManyToOne)(function () { return order_entity_1.Order; }, function (order) { return order.items; }), (0, typeorm_1.JoinColumn)({ name: 'order_id', referencedColumnName: 'orderId' })];
